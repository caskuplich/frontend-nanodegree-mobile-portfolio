...
// Functions changeSliderLabel and changePizzaSizes definitions are now declared
// out of resizePizzas function.
...
function changePizzaSizes(size) {
  // Get rid of determineDx function.
  // Determine the pizza size in percentage.
...
function updatePositions() {
  ...
  // Save the calculated scroll distance in scrollTop variable to move
  // it out of for loop.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  for (var i = 0; i < 24; i++) { // Reduced number of pizzas
